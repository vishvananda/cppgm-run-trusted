...
const char* const kPA6GrammarLines[] = {
	"translation-unit:",
	"	declaration* ST_EOF",
	"",
	"primary-expression:",
...
const size_t kPA6GrammarLineCount =
	sizeof(kPA6GrammarLines) / sizeof(kPA6GrammarLines[0]);

}  // namespace

vector<string> pa6_grammar_lines()
{
	return vector<string>(kPA6GrammarLines,
	                     kPA6GrammarLines + kPA6GrammarLineCount);
}
